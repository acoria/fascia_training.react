...
export const Home: React.FC = () => {
    ...
    const fasciaArea: IFasciaArea = { areaName: "Upper legs", trainings: [{ title: "Front rolling" }, { title: "Back rolling" }, { title: "Lay onto ball" }, { title: "Something even more painful until you roll for longer" }] }

    return <div className={styles.home}>
        <TurningPerson className={styles.turningPerson} />
        <div className={styles.fasciaArea}>
            <h1 className={styles.selectedPartTitle}>{fasciaArea.areaName}</h1>
            <FasciaTrainingList className={styles.trainingList} trainings={fasciaArea.trainings} />
        </div>
